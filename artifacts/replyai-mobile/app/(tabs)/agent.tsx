...
function MessageBubble({
  ...
  const s = StyleSheet.create({
    ...
    userBubble: { backgroundColor: colors.background, borderRadius: 18, borderBottomRightRadius: 4, paddingHorizontal: 14, paddingVertical: 10, maxWidth: "80%", borderWidth: 1, borderColor: colors.border },
    userText: { color: colors.foreground, fontSize: 14, fontFamily: "Inter_400Regular", lineHeight: 21 },
...
export default function AgentScreen() {
  ...
  const styles = StyleSheet.create({
    ...
    textInput: {
      ...
      fontFamily: "Inter_400Regular", maxHeight: 120, backgroundColor: colors.muted, lineHeight: 20,
    },
