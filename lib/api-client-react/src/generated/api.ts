...
export const agentRun = (
  body: BodyType<AgentRunBody>,
  options?: SecondParameter<typeof customFetch>,
) => {
  return customFetch<AgentRunResponse>(
    { url: `/api/agent/run`, method: "POST", data: body },
    options,
  );
};

export const getAgentRunMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof agentRun>>,
    TError,
...
> => {
  ...
  > = (props) => {
    const { data } = props ?? {};
    return agentRun(data, requestOptions);
  };
  return { mutationKey, mutationFn, ...mutationOptions };
};

export type AgentRunMutationResult = NonNullable<Awaited<ReturnType<typeof agentRun>>>;
export type AgentRunMutationBody = BodyType<AgentRunBody>;
export type AgentRunMutationError = ErrorType<unknown>;
...
>(options?: {
  ...
  TContext
> => {
  return useMutation(getAgentRunMutationOptions(options));
};

export const agentSend = (
  body: BodyType<AgentSendBody>,
  options?: SecondParameter<typeof customFetch>,
) => {
  return customFetch<AgentSendResponse>(
    { url: `/api/agent/send`, method: "POST", data: body },
    options,
  );
};

export const getAgentSendMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof agentSend>>,
    TError,
    { data: BodyType<AgentSendBody> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
> => {
  ...
  > = (props) => {
    const { data } = props ?? {};
    return agentSend(data, requestOptions);
  };
  return { mutationKey, mutationFn, ...mutationOptions };
};

export type AgentSendMutationResult = NonNullable<Awaited<ReturnType<typeof agentSend>>>;
export type AgentSendMutationBody = BodyType<AgentSendBody>;
export type AgentSendMutationError = ErrorType<unknown>;

export const useAgentSend = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getAgentSendMutationOptions(options));
};
