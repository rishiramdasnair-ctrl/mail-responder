...
export const ALL_CONNECTORS: ConnectorDef[] = [
  ...
  },
  {
    id: "github",
    label: "GitHub",
    description: "Browse repos, read and create issues, track PRs.",
    capabilities: ["List repositories", "Read issues & PRs", "Create issues", "Search code"],
    color: "#24292E",
    textColor: "#fff",
    initials: "GH",
    oauthPath: "/api/auth/github/start",
  },
  {
    id: "linear",
    label: "Linear",
    description: "Manage your Linear issues, projects, and sprints.",
    capabilities: ["List issues", "Create issues", "Update status", "Search projects"],
    color: "#5E6AD2",
    textColor: "#fff",
    initials: "L",
    oauthPath: "/api/auth/linear/start",
  },
  {
    id: "slack",
    label: "Slack",
